...
def main():
    ...
    # dataloader
    train_combined_loader = get_dataloader(dataset_path=args.dataset_path, mode='train', type='fake')
    test_combined_loader = get_dataloader(dataset_path=args.dataset_path, mode='test', type='fake')
